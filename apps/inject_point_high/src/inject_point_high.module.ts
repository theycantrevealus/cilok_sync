...
import { InjectPointHighController } from './inject_point_high.controller';
...
@Module({
    ...
    WinstonModule.forRootAsync({
      ...
      useFactory: (configService: ConfigService) => {
        ...
        return {
          ...
          handleRejections: true,
          handleExceptions: true,
          transports: WinstonCustomTransport[targetEnv].inject_point_high,
        };
      },
    }),
  ...
  controllers: [InjectPointHighController],
  providers: [
    InjectService,
...
export class InjectPointHighModule {}

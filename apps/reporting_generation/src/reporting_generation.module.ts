...
} from '@reporting_statistic/model/channel_trends/unique.channel.trends.model';
import {
  ReportErrorRedeemerTrends,
  ReportErrorRedeemerTrendsSchema,
} from '@reporting_statistic/model/error-redeemer-trends/error.redeemer.trends.model';
import {
  ReportErrorRedeemerTrendsSummary,
  ReportErrorRedeemerTrendsSummarySchema,
} from '@reporting_statistic/model/error-redeemer-trends/error.redeemer.trends.summary.model';
import {
  ReportTrendErrorRedeem,
  ReportTrendErrorRedeemSchema,
} from '@reporting_statistic/model/error-redeemer-trends/report-trend-error-redeem.model';
import {
  ReportFactDetail,
  ReportFactDetailSchema,
} from '@reporting_statistic/model/fact-detail/report-fact-detail.model';
import {
  ReportKeywordTransaction,
  ReportKeywordTransactionSchema,
} from '@reporting_statistic/model/keyword-transaction/report-keyword-transaction.model';
import {
  LocationPrefix,
  LocationPrefixSchema,
} from '@reporting_statistic/model/location-prefix/location-prefix.mode';
import {
  ReportProgramHistory,
  ReportProgramHistorySchema,
} from '@reporting_statistic/model/program/unique.program.history.model';
import {
  ReportRedeemTransaction,
  ReportRedeemTransactionSchema,
} from '@reporting_statistic/model/redeem-transaction/redeem-transaction.model';
import {
  ReportMonitoring,
...
} from '@reporting_statistic/model/reward/unique.reward.live.system.model';
import {
  ReportUniqueRewardTransaction,
  ReportUniqueRewardTransactionSchema,
} from '@reporting_statistic/model/reward/unique.reward.transaction.model';
import {
  TransactionMasterDetail,
  TransactionMasterDetailSchema,
} from '@reporting_statistic/model/trx-master-detail.model';
import {
  CouponGenerateUniqueMsisdn,
  CouponGenerateUniqueMsisdnSchema,
} from '@reporting_statistic/model/unique_msisdn/coupon.generate.unique.msisdn.daily.model';
import {
  MsisdnRedeemTransactionTemp,
  MsisdnRedeemTransactionTempSchema,
} from '@reporting_statistic/model/unique_msisdn/msisdn.redeem.transaction.temp';
import {
  ReportUniqueMSISDN,
...
} from '@reporting_statistic/model/unique_msisdn/unique.msisdn.monthly.model';
import {
  YearlyReportUniqueMSISDN,
  YearlyReportUniqueMSISDNSchema,
} from '@reporting_statistic/model/unique_msisdn/unique.msisdn.yearly.model';
import { ReportingStatisticService } from '@reporting_statistic/reporting_statistic.service';
import { ReportingTrendsChannelService } from '@reporting_statistic/services/channel_trends/reporting-channel-trends.service';
import { ReportingErrorRedeemerTrendsService } from '@reporting_statistic/services/error-redeemer-trends/error-redeemer-trends.service';
import { ReportTrendErrorRedeemService } from '@reporting_statistic/services/error-redeemer-trends/report-trend-error-redeem.service';
import { ReportingFactDetailService } from '@reporting_statistic/services/fact-detail/reporting-fact-detail.service';
...
import { ReportKeywordTransactionService } from '@reporting_statistic/services/keyword-transaction/report-keyword-transaction.service';
...
import { ReportingQuotaStockDailyService } from '@reporting_statistic/services/quota-stock-daily/reporting-quota-stock-daily.service';
import { ReportRedeemTransactionService } from '@reporting_statistic/services/redeem-transaction/redeem-transaction.service';
import { ReportRedeemerMyTselService } from '@reporting_statistic/services/redeemer_mytsel/redeemer-mytsel.service';
import { ReportingNotificationService } from '@reporting_statistic/services/reporting_notification/reporting-notification.service';
import { GeneralReportingCoreService } from '@reporting_statistic/services/reporting-core/general-reporting-core.service';
import { RequestReportingCoreService } from '@reporting_statistic/services/reporting-core/request-reporting-core.service';
...
import { ReportTransactionService } from '@reporting_statistic/services/transaction/reporting-transaction.service';
...
import { ReportingGenerateCouponUniqueMsisdnService } from '@reporting_statistic/services/unique-msisdn/reporting-generate-coupon-unique-msisdn.service';

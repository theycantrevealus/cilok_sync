export default () => ({
  ip: process.env.CORE_BACKEND_IP,
  'tsel-core-backend': {
  ...
  'core-backend': {
    ...
    raw_bi: process.env.CORE_BACK_END_BI,
    raw_port: process.env.CORE_BACK_END_PORT,
    raw_port_bi: process.env.CORE_BACK_END_PORT_BI,
    ...
    api: {
      ...
      'url-customer': `${process.env.CORE_BACKEND_API_URL}`,
      'token-gateway': process.env.CORE_BACKEND_API_TOKEN_GATEWAY,
      'refresh-token': process.env.CORE_BACKEND_API_REFRESH_TOKEN,
    },
    bi_cert_ca: process.env.BI_CERT_CA ?? '',
    bi_cert: process.env.BI_CERT ?? '',
    bi_timeout: process.env.CORE_BACK_END_BI_TIMEOUT ?? 0,
    client: {
      username: process.env.CORE_INTERNAL_USERNAME,
      password: process.env.CORE_INTERNAL_PASSWORD,
      id: process.env.CORE_BACKEND_CLIENT_ID,
      secret: process.env.CORE_BACKEND_CLIENT_SECRET,
    },
    realm: {
    ...
    voting_product: {
      id: process.env.CORE_BACKEND_VOTING_PRODUCT_ID,
    },
    sms_auction_product: {
      id: process.env.CORE_BACKEND_SMS_AUCTION_PRODUCT_ID,
    },
    e_auction_product: {
      id: process.env.CORE_BACKEND_E_AUCTION_PRODUCT_ID,
    },
  },
});

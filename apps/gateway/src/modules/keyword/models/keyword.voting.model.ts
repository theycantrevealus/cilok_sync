...
export type KeywordVotingDocument = KeywordVoting & Document;

@Schema()
export class KeywordVoting {
  @IsString()
  bonus_type: string;
...
const exampleVoting: KeywordVoting = new KeywordVoting(
  'voting',
  90,
  [
    { name: 'Naif', description: 'Description 1' },
    { name: 'Noah', description: 'Description 1' },
    { name: 'Sheila on 7', description: 'Description 1' },
  ],
  [
...
export { exampleVoting };
export const KeywordVotingSchema = SchemaFactory.createForClass(KeywordVoting);

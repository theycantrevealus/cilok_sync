...
export type KeywordLinkajaDocument = KeywordLinkaja & Document;
export type KeywordLinkajaVoucherDocument = KeywordLinkajaVoucher & Document;

@Schema()
export class KeywordLinkaja {
  @IsString()
  bonus_type: string;
...
export class KeywordLinkajaVoucher {
  @IsString()
  bonus_type: string;
...
const exampleLinkaja: KeywordLinkaja = new KeywordLinkaja(
  'linkaja_main',
  9999,
  true,
  '',
...
export { exampleLinkaja };

const exampleLinkajaBonus: KeywordLinkaja = new KeywordLinkaja(
  'linkaja_bonus',
  9999,
  true,
  '',
...
export { exampleLinkajaBonus };

export const KeywordLinkajaSchema =
  SchemaFactory.createForClass(KeywordLinkaja);

const exampleLinkajaVoucher: KeywordLinkajaVoucher = new KeywordLinkajaVoucher(
  'linkaja_voucher',
  [
    new KeywordStockLocation(
      '62ffd9ed1e38fbdeb16f1f53',
...
export { exampleLinkajaVoucher };

export const KeywordLinkajaVoucherSchema = SchemaFactory.createForClass(

...
export type KeywordEAuctionDocument = KeywordEAuction & Document;

@Schema()
export class KeywordEAuction {
  @IsString()
  bonus_type: string;
...
const exampleEAuction: KeywordEAuction = new KeywordEAuction(
  'e_auction',
  22,
  10,
  'VALUE || LAST_BID',
  ...
  'https://complete-url-until-extention.jpg',
  [
...
export { exampleEAuction };

export const KeywordEAuctionSchema =
  SchemaFactory.createForClass(KeywordEAuction);

...
export type KeywordTelcoPostpaidDocument = KeywordTelcoPostpaid & Document;

@Schema()
export class KeywordTelcoPostpaid {
  @IsString()
  bonus_type: string;
  ...
  constructor(
    ...
    this.telco_post_product_name = telco_post_product_name;
    this.telco_post_bid = telco_post_bid;
    this.telco_post_api_config = telco_post_api_config;
...
const exampleTelcoPost: KeywordTelcoPostpaid = new KeywordTelcoPostpaid(
  'telco_postpaid',
...
export { exampleTelcoPost };

export const KeywordTelcoPostpaidSchema =
  SchemaFactory.createForClass(KeywordTelcoPostpaid);

...
export type KeywordLoyaltyPoinDocument = KeywordLoyaltyPoin & Document;

@Schema()
export class KeywordLoyaltyPoin {
  @IsString()
  bonus_type: string;
  ...
  constructor(
    ...
    this.earning_poin = earning_poin;
...
const exampleLoyaltyPoin: KeywordLoyaltyPoin = new KeywordLoyaltyPoin(
  'loyalty_poin',
  100,
  [
...
export { exampleLoyaltyPoin };

export const KeywordLoyaltyPoinSchema =
  SchemaFactory.createForClass(KeywordLoyaltyPoin);

 ...
 * @deprecated
 */
export class CampaignWithReceiptAddDTO {
  @ApiProperty({
    type: String,
    required: true,
...
export class CampaignAddDTOResponse {
  @ApiProperty({ example: 200 })
  @IsNumber()
  status: number;

  @ApiProperty({ example: 'Campaign added data successfuly' })
  @IsString()
  message: string;

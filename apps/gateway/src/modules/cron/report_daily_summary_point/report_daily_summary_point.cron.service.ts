...
import { ReportWithStockJobService } from './report_daily_summary_point.job.service';

const CRONJOB_NAME = 'REPORT_DAILY_SUMMARY_POINT';
const CRONJOB_DESCRIPTION =
  'Cronjob for reports on Summary POIN that currently generated daily and shared via email.';

@Injectable()
export class ReportDailySummaryPoinCronService {
  constructor(

...
const TRANSACTION_CLASSIFY = 'VOUCHER_VERIFICATION';

export class VerificationVoucherResponseOk {
  @ApiProperty({
...
export class VerificationVoucherResponseCreated {
  @ApiProperty({
...
export class VerificationVoucherResponseAccepted {
  @ApiProperty({
...
export class VerificationVoucherResponseNoContent {
  @ApiProperty({
...
export class VerificationVoucherResponseBadRequest {
  @ApiProperty({
    example: 'E02000',
    default: 'E02000',
...
export class VerificationVoucherResponseUnauthorized {
  @ApiProperty({
    example: 'E01001',
    default: 'E01001',
...
export class VerificationVoucherResponseNotFound {
  @ApiProperty({
    example: 'E00000',
    default: 'E00000',
...
export class VerificationVoucherResponseForbidden {
  @ApiProperty({
    example: 'E01002',
    default: 'E01002',
...
export class VerificationVoucherResponseMethodNotAllowed {
  @ApiProperty({
    example: 'E02002',
    default: 'E02002',
...
export class VerificationVoucherResponseUnprocessableEntity {
  @ApiProperty({
    example: 'E7002',
    default: 'E7002',
...
export class VerificationVoucherResponseFailedDepedency {
  @ApiProperty({
...
export class VerificationVoucherResponseInternalServerError {
  @ApiProperty({
    example: 'X00000',
    default: 'X00000',

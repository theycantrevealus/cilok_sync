...
import {
  ProgramWinnerResponseAccepted,
  ProgramWinnerResponseBadRequest,
  ProgramWinnerResponseCreated,
  ProgramWinnerResponseForbidden,
  ProgramWinnerResponseInternalServerError,
  ProgramWinnerResponseMethodNotAllowed,
  ProgramWinnerResponseNoContent,
  ProgramWinnerResponseNotFound,
  ProgramWinnerResponseOk,
  ProgramWinnerResponseUnauthorized,
  ProgramWinnerResponseUnprocessableEntity,
} from '@/transaction/dtos/program/winner/winner.program.response.dto';

const ApiResponseProgramWinner = {
  R200: {
    status: HttpStatus.OK,
    type: ProgramWinnerResponseOk,
  ...
  R201: {
    ...
    type: ProgramWinnerResponseCreated,
    description: `The HTTP 201 Created success status response code indicates that <b>the request has succeeded and has led to the creation of a resource</b>.`,
  },
  R202: {
    status: HttpStatus.ACCEPTED,
    type: ProgramWinnerResponseAccepted,
    description: `The HTTP 201 Created success status response code indicates that <b>the request has succeeded and has led to the creation of a resource</b>.`,
  },
  R204: {
    status: HttpStatus.NO_CONTENT,
    type: ProgramWinnerResponseNoContent,
  ...
  R400: {
    ...
    type: ProgramWinnerResponseBadRequest,
  ...
  R401: {
    ...
    type: ProgramWinnerResponseUnauthorized,
  ...
  R403: {
    ...
    type: ProgramWinnerResponseForbidden,
  ...
  R404: {
    ...
    example: 404,
    type: ProgramWinnerResponseNotFound,
  ...
  R405: {
    ...
    type: ProgramWinnerResponseMethodNotAllowed,
  ...
  R422: {
    ...
    type: ProgramWinnerResponseUnprocessableEntity,
  ...
  R500: {
    ...
    type: ProgramWinnerResponseInternalServerError,
...
export { ApiResponseProgramWinner };

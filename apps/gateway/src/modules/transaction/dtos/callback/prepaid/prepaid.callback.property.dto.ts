...
import {
  CallbackPrepaidResponseAccepted,
  CallbackPrepaidResponseBadRequest,
  CallbackPrepaidResponseCreated,
  CallbackPrepaidResponseForbidden,
  CallbackPrepaidResponseInternalServerError,
  CallbackPrepaidResponseMethodNotAllowed,
  CallbackPrepaidResponseNoContent,
  CallbackPrepaidResponseNotFound,
  CallbackPrepaidResponseOk,
  CallbackPrepaidResponseUnauthorized,
  CallbackPrepaidResponseUnprocessableEntity,
} from '@/transaction/dtos/callback/prepaid/prepaid.callback.response.dto';

const ApiResponseCallbackPrepaid = {
  R200: {
    status: HttpStatus.OK,
    type: CallbackPrepaidResponseOk,
  ...
  R201: {
    ...
    type: CallbackPrepaidResponseCreated,
    description: `The HTTP 201 Created success status response code indicates that <b>the request has succeeded and has led to the creation of a resource</b>.`,
  },
  R202: {
    status: HttpStatus.ACCEPTED,
    type: CallbackPrepaidResponseAccepted,
    description: `The HTTP 201 Created success status response code indicates that <b>the request has succeeded and has led to the creation of a resource</b>.`,
  },
  R204: {
    status: HttpStatus.NO_CONTENT,
    type: CallbackPrepaidResponseNoContent,
  ...
  R400: {
    ...
    type: CallbackPrepaidResponseBadRequest,
  ...
  R401: {
    ...
    type: CallbackPrepaidResponseUnauthorized,
  ...
  R403: {
    ...
    type: CallbackPrepaidResponseForbidden,
  ...
  R404: {
    ...
    example: 404,
    type: CallbackPrepaidResponseNotFound,
  ...
  R405: {
    ...
    type: CallbackPrepaidResponseMethodNotAllowed,
  ...
  R422: {
    ...
    type: CallbackPrepaidResponseUnprocessableEntity,
  ...
  R500: {
    ...
    type: CallbackPrepaidResponseInternalServerError,
...
export { ApiResponseCallbackPrepaid };

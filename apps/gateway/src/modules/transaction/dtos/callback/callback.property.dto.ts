...
import {
  CallbackResponseAccepted,
  CallbackResponseBadRequest,
  CallbackResponseCreated,
  CallbackResponseForbidden,
  CallbackResponseInternalServerError,
  CallbackResponseMethodNotAllowed,
  CallbackResponseNoContent,
  CallbackResponseNotFound,
  CallbackResponseOk,
  CallbackResponseUnauthorized,
  CallbackResponseUnprocessableEntity,
} from '@/transaction/dtos/callback/callback.response.dto';

const ApiOperationCallback = {
  callback: {
    summary: 'Callback',
    description:
      'This API used to allowed channel as backend to send information transaction status to SmileLoyalty',
  },
  prepaid: {
    summary: 'Callback Provisioning Prepaid Product',
    description:
      'This API used to allowed channel as backend to send information transaction status to SmileLoyalty',
  },
  postpaid: {
    summary: 'Callback Provisioning Postpaid Product',
    description: 'API Call back transactions',
  },
};

const ApiResponseCallback = {
  R200: {
    status: HttpStatus.OK,
    type: CallbackResponseOk,
  ...
  R201: {
    ...
    type: CallbackResponseCreated,
    description: `The HTTP 201 Created success status response code indicates that <b>the request has succeeded and has led to the creation of a resource</b>.`,
  },
  R202: {
    status: HttpStatus.ACCEPTED,
    type: CallbackResponseAccepted,
    description: `The HTTP 201 Created success status response code indicates that <b>the request has succeeded and has led to the creation of a resource</b>.`,
  },
  R204: {
    status: HttpStatus.NO_CONTENT,
    type: CallbackResponseNoContent,
  ...
  R400: {
    ...
    type: CallbackResponseBadRequest,
  ...
  R401: {
    ...
    type: CallbackResponseUnauthorized,
  ...
  R403: {
    ...
    type: CallbackResponseForbidden,
  ...
  R405: {
    ...
    type: CallbackResponseMethodNotAllowed,
  ...
  R422: {
    ...
    type: CallbackResponseUnprocessableEntity,
  ...
  R500: {
    ...
    type: CallbackResponseInternalServerError,
...
export { ApiOperationCallback, ApiResponseCallback };

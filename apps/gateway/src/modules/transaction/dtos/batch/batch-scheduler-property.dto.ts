...
import {
  BatchSchedulerErrorResponse,
  BatchSchedulerResponse,
} from '@/transaction/dtos/batch/batch-scheduler-response.dto';

const ApiOperationBatchScheduler = {
  primeDT: {
...
const ApiResponseBatchScheduler = {
  R200: {
    status: HttpStatus.OK,
    type: BatchSchedulerResponse,
  ...
  R400: {
    ...
    type: BatchSchedulerErrorResponse,

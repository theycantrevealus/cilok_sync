...
import {
  RedeemResponseAccepted,
  RedeemResponseBadRequest,
  RedeemResponseCreated,
  RedeemResponseForbidden,
  RedeemResponseInternalServerError,
  RedeemResponseMethodNotAllowed,
  RedeemResponseNoContent,
  RedeemResponseNotFound,
  RedeemResponseOk,
  RedeemResponseUnauthorized,
  RedeemResponseUnprocessableEntity,
} from '@/transaction/dtos/redeem/redeem.response.dto';

const ApiOperationRedeem = {
  redeem: {
    summary: 'Redeem',
    description: 'This API used to redeem process. ',
  },
  get_msisdn_redeemer: {
    summary: 'Get MSISDN Redeemer',
    description: 'This API used to get msisdn redeemer by keyword.',
  }
};

const ApiResponseRedeem = {
  R200: {
  ...
  R201: {
    ...
    type: RedeemResponseCreated,
    description: `The HTTP 201 Created success status response code indicates that <b>the request has succeeded and has led to the creation of a resource</b>.`,
  },
  R202: {
    status: HttpStatus.ACCEPTED,
    type: RedeemResponseAccepted,
    description: `The HTTP 201 Created success status response code indicates that <b>the request has succeeded and has led to the creation of a resource</b>.`,
  },
  R204: {
    status: HttpStatus.NO_CONTENT,
    type: RedeemResponseNoContent,
  ...
  R401: {
    ...
    type: RedeemResponseUnauthorized,
  ...
  R405: {
    ...
    type: RedeemResponseMethodNotAllowed,
  ...
  R422: {
    ...
    type: RedeemResponseUnprocessableEntity,
  ...
  R500: {
    ...
    type: RedeemResponseInternalServerError,
...
const ApiParamRedeem = {
  keyword: {
    name: 'keyword',
    type: String,
    required: true,
    description: `Keyword<space>VoucherCode`,
  },
};

export { ApiOperationRedeem, ApiParamRedeem, ApiResponseRedeem };

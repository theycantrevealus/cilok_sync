...
const TRANSACTION_CLASSIFY = 'REDEEM';

export class RedeemResponseOk {
  @ApiProperty({
...
export class RedeemResponseCreated {
  @ApiProperty({
...
export class RedeemResponseAccepted {
  @ApiProperty({
...
export class RedeemResponseNoContent {
  @ApiProperty({
...
export class RedeemResponseBadRequest {
  @ApiProperty({
...
export class RedeemResponseUnauthorized {
  @ApiProperty({
...
export class RedeemResponseNotFound {
  @ApiProperty({
...
export class RedeemResponseForbidden {
  @ApiProperty({
...
export class RedeemResponseMethodNotAllowed {
  @ApiProperty({
...
export class RedeemResponseUnprocessableEntity {
  @ApiProperty({
...
export class RedeemResponseFailedDepedency {
  @ApiProperty({
...
export class RedeemResponseInternalServerError {
  @ApiProperty({

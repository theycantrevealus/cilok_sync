...
import {
  DeductPointResponseAccepted,
  DeductPointResponseBadRequest,
  DeductPointResponseCreated,
  DeductPointResponseForbidden,
  DeductPointResponseInternalServerError,
  DeductPointResponseMethodNotAllowed,
  DeductPointResponseNoContent,
  DeductPointResponseNotFound,
  DeductPointResponseOk,
  DeductPointResponseUnauthorized,
  DeductPointResponseUnprocessableEntity,
} from '@/transaction/dtos/point/deduct/deduct.point.response.dto';

const ApiResponseDeductPoint = {
  R200: {
    status: HttpStatus.OK,
    type: DeductPointResponseOk,
  ...
  R201: {
    ...
    type: DeductPointResponseCreated,
    description: `The HTTP 201 Created success status response code indicates that <b>the request has succeeded and has led to the creation of a resource</b>.`,
  },
  R202: {
    status: HttpStatus.ACCEPTED,
    type: DeductPointResponseAccepted,
    description: `The HTTP 201 Created success status response code indicates that <b>the request has succeeded and has led to the creation of a resource</b>.`,
  },
  R204: {
    status: HttpStatus.NO_CONTENT,
    type: DeductPointResponseNoContent,
  ...
  R400: {
    ...
    type: DeductPointResponseBadRequest,
  ...
  R401: {
    ...
    type: DeductPointResponseUnauthorized,
  ...
  R403: {
    ...
    type: DeductPointResponseForbidden,
  ...
  R404: {
    ...
    example: 404,
    type: DeductPointResponseNotFound,
  ...
  R405: {
    ...
    type: DeductPointResponseMethodNotAllowed,
  ...
  R422: {
    ...
    type: DeductPointResponseUnprocessableEntity,
  ...
  R500: {
    ...
    type: DeductPointResponseInternalServerError,

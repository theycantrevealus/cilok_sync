...
const TRANSACTION_CLASSIFY = 'DEDUCT_POINT';

export class DeductPointResponseOk {
  @ApiProperty({
...
export class DeductPointResponseCreated {
  @ApiProperty({
...
export class DeductPointResponseAccepted {
  @ApiProperty({
...
export class DeductPointResponseNoContent {
  @ApiProperty({
...
export class DeductPointResponseBadRequest {
  @ApiProperty({
    example: 'E02000',
    default: 'E02000',
...
export class DeductPointResponseUnauthorized {
  @ApiProperty({
    example: 'E01001',
    default: 'E01001',
...
export class DeductPointResponseNotFound {
  @ApiProperty({
    example: 'E00000',
    default: 'E00000',
...
export class DeductPointResponseForbidden {
  @ApiProperty({
    example: 'E01002',
    default: 'E01002',
...
export class DeductPointResponseMethodNotAllowed {
  @ApiProperty({
    example: 'E02002',
    default: 'E02002',
...
export class DeductPointResponseUnprocessableEntity {
  @ApiProperty({
    example: 'E7002',
    default: 'E7002',
...
export class DeductPointResponseFailedDepedency {
  @ApiProperty({
...
export class DeductPointResponseInternalServerError {
  @ApiProperty({
    example: 'X00000',
    default: 'X00000',

...
import {
  RefundPointResponseAccepted,
  RefundPointResponseBadRequest,
  RefundPointResponseCreated,
  RefundPointResponseForbidden,
  RefundPointResponseInternalServerError,
  RefundPointResponseMethodNotAllowed,
  RefundPointResponseNoContent,
  RefundPointResponseNotFound,
  RefundPointResponseOk,
  RefundPointResponseUnauthorized,
  RefundPointResponseUnprocessableEntity,
} from '@/transaction/dtos/point/refund/refund.point.response.dto';

const ApiResponseRefundPoint = {
  R200: {
    status: HttpStatus.OK,
    type: RefundPointResponseOk,
  ...
  R201: {
    ...
    type: RefundPointResponseCreated,
    description: `The HTTP 201 Created success status response code indicates that <b>the request has succeeded and has led to the creation of a resource</b>.`,
  },
  R202: {
    status: HttpStatus.ACCEPTED,
    type: RefundPointResponseAccepted,
    description: `The HTTP 201 Created success status response code indicates that <b>the request has succeeded and has led to the creation of a resource</b>.`,
  },
  R204: {
    status: HttpStatus.NO_CONTENT,
    type: RefundPointResponseNoContent,
  ...
  R400: {
    ...
    type: RefundPointResponseBadRequest,
  ...
  R401: {
    ...
    type: RefundPointResponseUnauthorized,
  ...
  R403: {
    ...
    type: RefundPointResponseForbidden,
  ...
  R404: {
    ...
    example: 404,
    type: RefundPointResponseNotFound,
  ...
  R405: {
    ...
    type: RefundPointResponseMethodNotAllowed,
  ...
  R422: {
    ...
    type: RefundPointResponseUnprocessableEntity,
  ...
  R500: {
    ...
    type: RefundPointResponseInternalServerError,

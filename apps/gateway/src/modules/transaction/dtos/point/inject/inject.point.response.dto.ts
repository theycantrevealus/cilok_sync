...
const TRANSACTION_CLASSIFY = 'INJECT_POINT';

export class InjectPointResponseOk {
  @ApiProperty({
...
export class InjectPointResponseCreated {
  @ApiProperty({
...
export class InjectPointResponseAccepted {
  @ApiProperty({
...
export class InjectPointResponseNoContent {
  @ApiProperty({
...
export class InjectPointResponseBadRequest {
  @ApiProperty({
    example: 'E02000',
    default: 'E02000',
...
export class InjectPointResponseUnauthorized {
  @ApiProperty({
    example: 'E01001',
    default: 'E01001',
...
export class InjectPointResponseNotFound {
  @ApiProperty({
    example: 'E00000',
    default: 'E00000',
...
export class InjectPointResponseForbidden {
  @ApiProperty({
    example: 'E01002',
    default: 'E01002',
...
export class InjectPointResponseMethodNotAllowed {
  @ApiProperty({
    example: 'E02002',
    default: 'E02002',
...
export class InjectPointResponseUnprocessableEntity {
  @ApiProperty({
    example: 'E7002',
    default: 'E7002',
...
export class InjectPointResponseFailedDepedency {
  @ApiProperty({
...
export class InjectPointResponseInternalServerError {
  @ApiProperty({
    example: 'X00000',
    default: 'X00000',

...
import {
  InjectWhitelistResponseAccepted,
  InjectWhitelistResponseBadRequest,
  InjectWhitelistResponseCreated,
  InjectWhitelistResponseForbidden,
  InjectWhitelistResponseInternalServerError,
  InjectWhitelistResponseMethodNotAllowed,
  InjectWhitelistResponseNoContent,
  InjectWhitelistResponseNotFound,
  InjectWhitelistResponseOk,
  InjectWhitelistResponseUnauthorized,
  InjectWhitelistResponseUnprocessableEntity,
} from '@/transaction/dtos/whitelist/inject/inject.whitelist.response.dto';

const ApiResponseInjectWhitelist = {
  R200: {
    status: HttpStatus.OK,
    type: InjectWhitelistResponseOk,
  ...
  R201: {
    ...
    type: InjectWhitelistResponseCreated,
    description: `The HTTP 201 Created success status response code indicates that <b>the request has succeeded and has led to the creation of a resource</b>.`,
  },
  R202: {
    status: HttpStatus.ACCEPTED,
    type: InjectWhitelistResponseAccepted,
    description: `The HTTP 201 Created success status response code indicates that <b>the request has succeeded and has led to the creation of a resource</b>.`,
  },
  R204: {
    status: HttpStatus.NO_CONTENT,
    type: InjectWhitelistResponseNoContent,
  ...
  R400: {
    ...
    type: InjectWhitelistResponseBadRequest,
  ...
  R401: {
    ...
    type: InjectWhitelistResponseUnauthorized,
  ...
  R403: {
    ...
    type: InjectWhitelistResponseForbidden,
  ...
  R404: {
    ...
    example: 404,
    type: InjectWhitelistResponseNotFound,
  ...
  R405: {
    ...
    type: InjectWhitelistResponseMethodNotAllowed,
  ...
  R422: {
    ...
    type: InjectWhitelistResponseUnprocessableEntity,
  ...
  R500: {
    ...
    type: InjectWhitelistResponseInternalServerError,
...
export { ApiResponseInjectWhitelist };

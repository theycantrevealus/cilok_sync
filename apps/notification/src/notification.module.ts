...
import { EsbRedeemLoyaltyIntegration } from '../../gateway/src/modules/esb/integration/esb.redeem.loyalty.integration';
// import { SendNotificationGeneralService } from './services/send-notification-general.service';
...
@Module({
    ...
    WinstonModule.forRootAsync({
      ...
      useFactory: (configService: ConfigService) => {
        ...
        return {
          ...
          transports: WinstonCustomTransport[targetEnv].notification,
        };
      },
    }),
  ...
  providers: [
    ...
    EsbRedeemLoyaltyIntegration,
    EsbRedeemLoyaltyService,
  ],
})

...
export type ReportUniqueMSISDNDocument = ReportUniqueMSISDN & Document;
@Schema({
  collection: 'report_unique_msisdn_daily',
  timestamps: { createdAt: 'created_at', updatedAt: 'updated_at' },
})
export class ReportUniqueMSISDN {
  @ApiProperty({
    required: true,
    type: String,
    example: '2022-12-13',
    description: 'Period of daily record',
  })
  @IsString()
...
export const ReportUniqueMSISDNSchema =
  SchemaFactory.createForClass(ReportUniqueMSISDN);

...
export class KafkaController {
  ...
  @MessagePattern(process.env.KAFKA_ELIGIBILITY_LOW_TOPIC)
        ...
        .then(async (response) => {
          ...
          if (
            ...
            return await this.deductClient.emit(
              process.env.KAFKA_DEDUCT_LOW_TOPIC,
              response,
            );
          ...
          if (last_origin !== 'eligibility_fail') {
            // await this.transactionRecoveryService.setStep(payload, process.env.KAFKA_DEDUCT_LOW_TOPIC);
          }

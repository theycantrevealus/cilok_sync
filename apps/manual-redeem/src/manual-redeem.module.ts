...
import { BatchRedeemService as RedeemServiceBatch } from '@/transaction/services/redeem/batch_redeem.service';
...
@Module({
    ...
    WinstonModule.forRootAsync({
      ...
      useFactory: (configService: ConfigService) => {
        ...
        return {
          ...
          transports: WinstonCustomTransport[targetEnv].manual_redeem,
        };
      },
    }),
  ...
  providers: [
    ...
    RedeemServiceBatch, // BatchRedeemService
    RedeemService,
    PointService,
    DonationService,
    OTPService,
    ...
    ManualRedeemLogService,
    TransferPulsaService,
    BatchRedeemService,
...
export class ManualRedeemModule {}

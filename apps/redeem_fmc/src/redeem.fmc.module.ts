...
import { KafkaConnProducer } from '../../gateway/src/configs/kafka/client';
...
@Module({
    ...
    WinstonModule.forRootAsync({
      ...
      useFactory: (configService: ConfigService) => {
        ...
        return {
          ...
          transports: WinstonCustomTransport[targetEnv].redeem_fmc,
        };
      },
    }),
  ...
  controllers: [RedeemFmcController],
  providers: [
    EsbProfileService,

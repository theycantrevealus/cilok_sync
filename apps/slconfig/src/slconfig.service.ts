...
//     console.log(`Reloading ${[JSON.stringify(parameter)]}`);
//     const now = Date.now();
//     const query = [];
...
//       await Promise.all(
//         result.map(async (a) => {
//           await this.cacheManager.set(`keyword-${a._id.toString()}`, a);
//           await this.cacheManager.set(
//             `keyword-${a.eligibility.name.toString()}`,
//             a,
//           );
//         }),
//       ).then(() => {

...
export type VoucherBatchDocument = VoucherBatch & Document;

@Schema({
  collection: 'voucher_batch',
...
export const VoucherBatchSchema = SchemaFactory.createForClass(VoucherBatch);

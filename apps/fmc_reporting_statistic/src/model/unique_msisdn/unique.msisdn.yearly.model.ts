...
export type YearlyReportUniqueMSISDNDocument = YearlyReportUniqueMSISDN &
  Document;

@Schema({
  collection: 'report_unique_msisdn_yearly',
  timestamps: { createdAt: 'created_at', updatedAt: 'updated_at' },
})
export class YearlyReportUniqueMSISDN {
  @ApiProperty({
    required: true,
    type: String,
    example: '2022',
    description: 'Period of year record',
  })
  @IsString()
...
export const YearlyReportUniqueMSISDNSchema = SchemaFactory.createForClass(

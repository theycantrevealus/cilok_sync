...
import { SftpConfig, SftpConfigSchema } from './models/sftp.config.model';
import {
  SftpIncomingLog,
...
import { SftpResult, SftpResultSchema } from './models/sftp.result.model';
import { SftpFileReaderProcessor } from './processor/sftp.file.reader.processor';
...
@Module({
  imports: [
    ...
    ClientsModule.registerAsync([
      KafkaConn.sftp[0],
      KafkaConn.sftp_outgoing[0],
      KafkaConn.sftp_incoming[0],
      // KafkaConn.sftp_incoming_batch_process[0],

      KafkaConnProducer.sftp[0],
      KafkaConnProducer.sftp_outgoing[0],
      KafkaConnProducer.sftp_incoming[0],

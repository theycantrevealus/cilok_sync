...
import { KafkaCouponService } from '@coupon/coupon.service';
import { InjectCouponService } from '@coupon/service/inject.coupon.service';
import { CouponLogService } from '@coupon/service/log.service';
    ...
    WinstonModule.forRootAsync({
      ...
      useFactory: (configService: ConfigService) => {
        ...
        return {
          ...
          transports: WinstonCustomTransport[targetEnv].coupon_high,
        };
      },
    }),
    StockModule,
